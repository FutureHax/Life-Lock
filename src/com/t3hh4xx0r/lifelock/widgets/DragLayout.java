...
public class DragLayout extends ViewGroup {
	OnTimerDragDismissedListener dismissedListener;
	
	public void setDismissedListener(OnTimerDragDismissedListener dismissedListener) {
		this.dismissedListener = dismissedListener;
	}
	
	public interface OnTimerDragDismissedListener {
		void onDismissed();
	}
